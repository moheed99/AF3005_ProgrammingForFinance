...
house_themes = {
    "None": {
        "background": "https://example.com/futuristic-wizardry-background.jpg", # Replace with actual URL
        "primary": "#fedd00",
        "secondary": "#662d91",
        "text": "#eee7db",
    ...
    "Gryffindor": {
        "background": "https://example.com/gryffindor-futuristic-background.gif",  # Replace with actual URL
    ...
    "Slytherin": {
        "background": "https://example.com/slytherin-futuristic-background.gif", # Replace with actual URL
...
def welcome_page():
    st.markdown(
        ...
        <style>
        .welcome-screen {
            background-image: url('https://example.com/futuristic-wizardry-welcome.jpg'); /* Replace with actual URL */
            background-size: cover;
